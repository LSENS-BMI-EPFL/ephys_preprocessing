...
def main(input_dir, config_file):
    ...
    if mouse_name.startswith('AB'):
        session_name = input_dir.split('\\')[-2]
    elif mouse_name.startswith('PB'):
        session_name = input_dir.split('\\')[-1]
    else: # default folder structure
        session_name = input_dir.split('\\')[-2]
...
if __name__ == '__main__':
    ...
    args.input = r'M:\data\AB105\Recording\AB105_20240314_115206\Ephys' #until \session_id # TODO: PB mice
    args.input = r'M:\data\PB191\Recording\Ephys\PB191_20241210_110601' #until \session_id # TODO: PB mice
