% function [] = run_bombcell(ephys_ks_path, path_to_bin_file, path_to_meta_file, ks_version)
%% ~~ Example bombcell pipeline ~~
% Adjust the paths in the 'set paths' section and the parameters in bc_qualityParamValues
% This pipeline will:
%   (1) load your ephys datmatlabroot a, 
...
addpath(genpath('/home/lebert/code/spikesorting_pipeline/tools/npy-matlab'))
cd('/home/lebert/code/spikesorting_pipeline/tools/bombcell')
%% set paths - EDIT THESE 

ephys_ks_path = '/mnt/lsens/analysis/Jules_Lebert/data/PB191/PB191_20241210_110601/Ephys/catgt_PB191_g0/PB191_g0_imec0/kilosort2/phy';
path_to_bin_file = '/mnt/lsens/analysis/Jules_Lebert/data/PB191/PB191_20241210_110601/Ephys/catgt_PB191_g0/PB191_g0_imec0/PB191_g0_tcat.imec0.ap.bin';
path_to_meta_file = '/mnt/lsens/analysis/Jules_Lebert/data/PB191/PB191_20241210_110601/Ephys/catgt_PB191_g0/PB191_g0_imec0/PB191_g0_tcat.imec0.ap.meta';
ks_version = 4;
...
ephysMetaDir = dir(path_to_meta_file); % path to your .meta or .oebin meta file
saveLocation = ephys_ks_path; % where you want to save the quality metrics 
savePath = fullfile(ephys_ks_path, 'qMetrics'); 
decompressDataLocal = savePath; % where to save raw decompressed ephys data 
...
kilosortVersion = ks_version;% if using kilosort4, you need to change this value. Otherwise it does not matter. 
...
param.plotThis = 0; % do not plot individual units
